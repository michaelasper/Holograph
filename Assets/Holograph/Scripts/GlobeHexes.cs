...
public class GlobeHexes : MonoBehaviour
{
    ...
    void OnRenderObject()
    {
        ...
        Vector3 redmondHexPosition = redmondPosition.normalized * redmondRadius;
        Vector3 redmondX = Vector3.Cross(redmondHexPosition, new Vector3(0f, 1f, 0f)).normalized;
        Vector3 redmondY = Vector3.Cross(redmondHexPosition, redmondX).normalized;
        Color redmondColor = scarletColor;
        redmondColor.r *= redmondColorParameter;
        redmondColor.b /= redmondColorParameter;
        redmondColor.g /= redmondColorParameter;
        Vector3[] redmondQuad1 = new Vector3[4];
        Vector3[] redmondQuad2 = new Vector3[4];
        ...
        Transform redmondTextTransform = redmondText.transform;
        redmondTextTransform.localPosition = redmondPosition.normalized * 0.72f;
        redmondTextTransform.LookAt(this.transform);
